...
const translations = {
  en: {
    ...
    'contribute.github.leaderboardDesc': 'Rankings based on GitHub contributions including PRs, Issues, and code commits',
  ...
  'zh-CN': {
    ...
    'contribute.github.leaderboardDesc': '基于 PR、Issue、代码提交等 GitHub 贡献行为的综合积分排名',
