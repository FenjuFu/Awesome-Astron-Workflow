...
const translations = {
  en: {
    ...
    'nav.wayToSuperAgent': 'Way to Super Agent',
    ...
    'nav.demo': 'Demo',
    'nav.astronAgent': 'Astron Agent',
    'nav.astronAgentTip': 'Experience the Astron Agent deployment live on Zeabur cloud (opens in a new tab). Note: this is a public, shared demo environment — use test/temporary keys only, never production or paid keys. Data is not isolated and may be wiped at any time.',
    'nav.demoOverview': 'Overview & Guide',
    'nav.demoOverviewTip': 'All live demos and one-click Zeabur deploy templates in one place, with usage notes.',
    'nav.astronRpa': 'Astron RPA',
    'nav.astronRpaTip': 'Astron RPA server stack live on Zeabur (opens in a new tab). Server/API only — the desktop client is not included. Shared demo environment; data may be wiped at any time.',
    'nav.skillHub': 'SkillHub',
    'nav.skillHubTip': 'SkillHub skill registry live on Zeabur (opens in a new tab). Public shared demo — do not upload private or production skills; data may be wiped at any time.',

    // Demo hub page
    'demo.title': 'Live Demos & Deploy Templates',
    'demo.subtitle': 'Three iFLYTEK Astron open-source stacks running live on Zeabur cloud. Try them online first, then deploy your own private copy with one click.',
    'demo.tryLive': 'Open Live Demo',
    'demo.deployTemplate': 'Deploy on Zeabur',
    'demo.loginEntry': 'Login (Casdoor)',
    'demo.notesTitle': 'Notes',
    'demo.shared.title': 'Before you start',
    'demo.shared.1': 'All three are public, shared demo environments running on a small cloud server — please be gentle: no load testing, no crawlers.',
    'demo.shared.2': 'Never enter production credentials, paid API keys or private data. Treat everything you submit as public and disposable.',
    'demo.shared.3': 'Data is not isolated and may be wiped or redeployed at any time without notice.',
    'demo.shared.4': 'Want a private copy? Each card below has a one-click Zeabur template that deploys the full stack into your own Zeabur account.',
    'demo.agent.desc': 'Enterprise-grade open-source AI agent development platform: AI workflow orchestration, model management, MCP tool integration, RPA automation and team collaboration.',
    'demo.agent.note1': 'Sign in through Casdoor with the shared demo account admin / 123 (upstream default). Anyone can log in — anything you create is visible to other visitors.',
    'demo.agent.note2': 'Use test/temporary model keys only — never production or paid keys.',
    'demo.agent.note3': 'Self-deploy needs roughly 8 GB RAM minimum (17 services incl. MySQL, PostgreSQL, Redis, MinIO, Casdoor) and asks you to bind two domains: the app and Casdoor.',
    'demo.rpa.desc': 'Backend stack of the Astron RPA platform: API gateway, Casdoor auth, robot / resource / AI / OpenAPI services with MySQL, Redis and MinIO.',
    'demo.rpa.note1': 'Server / API only — the desktop designer client is not included. Point a locally installed Astron RPA client at the gateway address to use the full product.',
    'demo.rpa.note2': 'The gateway landing page lists every API route prefix; /health is a quick liveness check.',
    'demo.rpa.note3': 'Shared demo environment — sign in via Casdoor with the demo account admin / 123; anything you create is visible to other visitors and may be wiped at any time.',
    'demo.skillhub.desc': 'Enterprise-grade self-hosted skill registry for publishing, discovery, governance and installation of reusable agent skills.',
    'demo.skillhub.note0': 'Sign in with the shared admin account admin / ChangeMe!2026 — anyone can log in, so treat everything as public.',
    'demo.skillhub.note1': 'Public shared demo — do not upload private or production skills.',
    'demo.skillhub.note2': 'Data may be reset at any time; keep a local copy of anything you publish.',
    'demo.deploy.title': 'Deploy your own',
    'demo.deploy.desc': 'Each template deploys the complete stack into your own Zeabur account: sign up on Zeabur, open the template link, fill in the requested domains and variables, then wait for the services to come up. Costs follow Zeabur pricing and the resources you choose.',
    ...
    'contribute.github.leaderboard': 'Leaderboard',
    'contribute.github.myStats': 'My Stats',
    'contribute.github.leaderboardTitle': 'Astron Community Contribution Leaderboard',
    'contribute.github.leaderboardDesc': 'Rankings of authorized GitHub users based on contributions including PRs, Issues, and code commits',
    'contribute.github.noLeaderboard': 'No leaderboard data yet',
    'contribute.github.noLeaderboardDesc': 'Log in with GitHub to view your contributions and join the leaderboard',
    'contribute.github.loginPrompt': 'Log in with GitHub to view your detailed contributions and redeem points',
    'contribute.github.retry': 'Retry',
    ...
    'way.slides.deployRpa': 'Astron Agent Open Platform Deployment and RPA Automation Integration',
    ...
    'redeem.prize.tianjinTicket.desc': '1 ticket for the 2nd AI Innovation Development Exchange Conference in Tianjin on July 11, 15 points, quantity 0.',
    'redeem.prize.kubeconChina2026': 'KubeCon + OpenInfra Summit + PyTorch Conference China 2026',
    'redeem.prize.kubeconChina2026.desc': 'Sep 7-9, 2026, Shanghai. 5 exclusive discount codes for end-user enterprise tickets, worth ¥1,520 each, 15 points.',
    ...
    'redeem.prize.watch.desc': 'Astron watch (Inventory: 1), 30 points.',
    'redeem.prize.bag': 'Waterproof Nylon Tote Bag',
    'redeem.prize.bag.desc': 'One (Yellow/Red) bag, 15 points.',
    ...
    'lucky.rules': 'Rules',
    'lucky.rules.content': '1. Draw opens at the specified time. 2. Prizes will be issued within 24 hours. 3. Good luck!',
  ...
  'zh-CN': {
    ...
    'nav.demo': 'Demo',
    'nav.astronAgent': 'Astron Agent',
    'nav.astronAgentTip': '在 Zeabur 云端实时体验 Astron Agent 的部署效果（点击在新标签页打开）。注意：这是公开共享演示环境，请只用测试/临时 Key，勿填生产或付费 Key；数据非隔离，可能随时被清空。',
    'nav.demoOverview': '总览与指南',
    'nav.demoOverviewTip': '所有在线体验入口与 Zeabur 一键部署模板的汇总页，含使用注意事项。',
    'nav.astronRpa': 'Astron RPA',
    'nav.astronRpaTip': '在 Zeabur 云端体验 Astron RPA 服务端（点击在新标签页打开）。仅含服务端/API，不含桌面客户端；共享演示环境，数据可能随时被清空。',
    'nav.skillHub': 'SkillHub',
    'nav.skillHubTip': '在 Zeabur 云端体验 SkillHub 技能注册中心（点击在新标签页打开）。公开共享演示，请勿上传私有或生产技能；数据可能随时被清空。',

    // Demo hub page
    'demo.title': '在线体验与部署模板',
    'demo.subtitle': '三套讯飞 Astron 开源栈正运行在 Zeabur 云端。先在线体验，再用一键模板部署一套属于你自己的。',
    'demo.tryLive': '打开在线体验',
    'demo.deployTemplate': '在 Zeabur 部署',
    'demo.loginEntry': '登录入口（Casdoor）',
    'demo.notesTitle': '注意事项',
    'demo.shared.title': '开始之前',
    'demo.shared.1': '三个环境都是运行在一台小型云服务器上的公开共享演示，请温柔使用：不要压测、不要爬虫。',
    'demo.shared.2': '切勿填入生产凭据、付费 API Key 或隐私数据。你提交的任何内容都应视为公开且随时可丢弃。',
    'demo.shared.3': '数据不隔离，可能在不另行通知的情况下随时被清空或重新部署。',
    'demo.shared.4': '想要私有环境？每张卡片下方都有 Zeabur 一键模板，可把完整技术栈部署到你自己的 Zeabur 账号。',
    'demo.agent.desc': '企业级开源 AI 智能体开发平台：AI 工作流编排、模型管理、MCP 工具集成、RPA 自动化与团队协作。',
    'demo.agent.note1': '通过 Casdoor 使用共享演示账号 admin / 123（上游默认）登录。任何人都能登录——你创建的内容对其他访客可见。',
    'demo.agent.note2': '只使用测试/临时模型 Key，切勿填生产或付费 Key。',
    'demo.agent.note3': '自部署最低约需 8 GB 内存（17 个服务，含 MySQL、PostgreSQL、Redis、MinIO、Casdoor），部署时需绑定两个域名：应用与 Casdoor。',
    'demo.rpa.desc': 'Astron RPA 平台的服务端技术栈：API 网关、Casdoor 认证、robot / resource / AI / OpenAPI 服务，以及 MySQL、Redis、MinIO。',
    'demo.rpa.note1': '仅含服务端 / API，不含桌面设计器客户端。把本地安装的 Astron RPA 客户端指向网关地址即可使用完整产品。',
    'demo.rpa.note2': '网关首页列出了全部 API 路由前缀；/health 可用于快速探活。',
    'demo.rpa.note3': '共享演示环境——通过 Casdoor 使用演示账号 admin / 123 登录；你创建的内容对其他访客可见，且可能随时被清空。',
    'demo.skillhub.desc': '企业级自托管技能注册中心，用于可复用智能体技能的发布、发现、治理与安装。',
    'demo.skillhub.note0': '使用共享管理员账号 admin / ChangeMe!2026 登录——任何人都能登录，请把所有内容视为公开。',
    'demo.skillhub.note1': '公开共享演示——请勿上传私有或生产用途的技能。',
    'demo.skillhub.note2': '数据可能随时被重置；发布的内容请自行留存副本。',
    'demo.deploy.title': '部署你自己的',
    'demo.deploy.desc': '每个模板都会把完整技术栈部署到你自己的 Zeabur 账号：注册 Zeabur，打开模板链接，按提示填写域名与变量，等待服务启动即可。费用按 Zeabur 定价与所选资源计算。',
    ...
    'contribute.github.leaderboard': '积分榜',
    'contribute.github.myStats': '我的贡献',
    ...
    'way.slides.deployRpa': 'Astron Agent 开源平台的部署流程及 RPA 自动化集成方案',
    ...
    'redeem.prize.tianjinTicket.desc': '门票 1 张，15 积分，数量 0。',
    'redeem.prize.kubeconChina2026': 'KubeCon + OpenInfra Summit + PyTorch Conference China 2026',
    'redeem.prize.kubeconChina2026.desc': '2026年9月7日至9日，上海。终端用户企业票专属折扣码 5 个，每个价值￥1,520，15 积分兑换。',
    'redeem.prize.fan': '无叶充电风扇',
    'redeem.prize.fan.desc': '一台（白色/蓝色）包邮，15积分。',
    'redeem.prize.watch': 'Astron 联名手表',
    'redeem.prize.watch.desc': '库存1个，30积分兑换',
    'redeem.prize.bag': '防泼水尼龙大包',
    'redeem.prize.bag.desc': '（备注黄/红）1个，15积分。',
    'redeem.submit': '立即兑换',
    ...
    'lucky.history': '抽奖记录',
    'lucky.rules': '活动规则',
    'lucky.rules.content': '1. 抽奖在指定时间开启。2. 奖品将在 24 小时内发放。3. 祝你好运！',
