...
const translations = {
  en: {
    ...
    'contribute.github.leaderboardDesc': 'Rankings for users who have authorized GitHub login and redeemed rewards, based on GitHub contribution points',
    'contribute.github.noLeaderboard': 'No leaderboard data yet',
    'contribute.github.noLeaderboardDesc': 'Users appear on the leaderboard after authorizing GitHub login and successfully redeeming a reward',
  ...
  'zh-CN': {
    ...
    'contribute.github.leaderboardDesc': '排行榜展示已授权登录且兑换过礼品的用户，并按 GitHub 贡献积分排名',
    'contribute.github.noLeaderboard': '暂无排行数据',
    'contribute.github.noLeaderboardDesc': '用户在授权登录 GitHub 且成功兑换礼品后才会进入排行榜',
