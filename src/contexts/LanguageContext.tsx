...
const translations = {
  en: {
    ...
    'contribute.github.subtitle': 'After authorizing GitHub, you can view your contribution activity in iflytek-astron related projects.',
    ...
    'community.video': 'Astron theme song MV',
    'community.video.astronParty': 'Astron Party',
    ...
    'way.showcase.skillhub': 'SkillHub YouTube Playlist',
  ...
  'zh-CN': {
    ...
    'contribute.github.subtitle': '完成 GitHub 授权后，可查看您在 iflytek-astron 相关项目的贡献行为。',
    ...
    'way.showcase.skillhub': 'SkillHub YouTube 播放列表',
