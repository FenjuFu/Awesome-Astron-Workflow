...
const translations = {
  en: {
    ...
    'nav.astronAgentTip': 'Experience the Astron Agent deployment live on Zeabur cloud — opens in a new tab.',
  ...
  'zh-CN': {
    ...
    'nav.demo': 'Demo',
    'nav.astronAgent': 'Astron Agent',
    'nav.astronAgentTip': '在 Zeabur 云端实时体验 Astron Agent 的部署效果，点击将在新标签页打开。',
