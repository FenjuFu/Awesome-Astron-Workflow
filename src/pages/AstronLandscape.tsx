        ...
        <div className="scale-container flex justify-center items-start w-full overflow-auto">
          ...
          >
            ...
            <div className="h-20 flex items-center justify-between px-8 bg-transparent border-b-2 border-white/50 relative z-[100]">
              <div className={`${isZH ? 'text-3xl' : 'text-2xl'} font-black text-slate-900 flex items-center gap-4 drop-shadow-md`}>
                <svg width={isZH ? "32" : "28"} height={isZH ? "32" : "28"} viewBox="0 0 16 16" fill="currentColor">
